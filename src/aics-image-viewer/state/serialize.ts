...
export function viewerStateToSnapshot(state: Partial<ViewerState>, removeDefaults: boolean): ViewerStateSnapshot {
  ...
  const result: ViewerStateSnapshot = {
    ...
    [ViewerStateSnapshotKeys.Mask]: s.maskAlpha,
    [ViewerStateSnapshotKeys.Image]: s.imageType && IMAGE_TYPE_TO_SNAPSHOT[s.imageType],
    [ViewerStateSnapshotKeys.Axes]: s.showAxes,
    [ViewerStateSnapshotKeys.BoundingBox]: s.showBoundingBox,
...
export const stringifyViewerStateSnapshot = (snapshot: ViewerStateSnapshot): ViewerStateStringified =>
  stringify(snapshot, {
    ...
    [ViewerStateSnapshotKeys.Mask]: formatFloat,
    [ViewerStateSnapshotKeys.Image]: identity,
    [ViewerStateSnapshotKeys.Axes]: stringifyBoolean,
    [ViewerStateSnapshotKeys.BoundingBox]: stringifyBoolean,
