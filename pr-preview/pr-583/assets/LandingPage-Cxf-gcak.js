...
`;function H(e){let{dataset:t,index:n,onClickLoad:r}=e;return(0,M.jsxs)(V,{children:[(0,M.jsx)(`h3`,{children:t.name}),(0,M.jsx)(`p`,{children:t.description}),(0,M.jsx)(`div`,{children:(0,M.jsxs)(u,{type:`primary`,onClick:()=>r(t.loadParams,t.hideTitle),style:{paddingTop:5},children:[`Load`,(0,M.jsxs)(f,{children:[` dataset `,t.name]})]})})]},n)}function U(e){let{datasets:t,onClickLoad:n}=e;return(0,M.jsx)(B,{children:t.map((e,t)=>(0,M.jsx)(H,{dataset:e,index:t,onClickLoad:n},t))})}var W=h.li`
  display: flex;
  width: 100%;
...
`;function K(e){let{project:n,index:r,onClickLoad:i}=e,a=n.inReview?(0,M.jsxs)(C,{$gap:10,children:[(0,M.jsx)(`h2`,{children:n.name}),(0,M.jsx)(t,{title:`Final version of dataset will be released when associated paper is published`,children:(0,M.jsx)(G,{children:(0,M.jsx)(`p`,{children:`IN REVIEW`})})})]}):(0,M.jsx)(`h2`,{children:n.name}),o=n.publicationInfo,s=o?(0,M.jsxs)(`p`,{children:[`Related publication: `,(0,M.jsx)(x,{href:o.url.toString(),children:o.name}),` (`,o.citation,`)`]}):null,c=n.loadParams?(0,M.jsx)(`div`,{children:(0,M.jsxs)(u,{onClick:()=>i(n.loadParams,n.hideTitle),style:{paddingTop:5},children:[`Load`,(0,M.jsxs)(f,{children:[` dataset `,n.name]})]})}):null,l=n.datasets?(0,M.jsx)(U,{datasets:n.datasets,onClickLoad:i}):null;return(0,M.jsxs)(W,{children:[a,(0,M.jsx)(`p`,{children:n.description}),s,c,l]},r)}var q=h.ul`
  display: flex;
  flex-direction: column;
  gap: 20px;
  padding: 0;
...
`;function J(e){return(0,M.jsx)(q,{children:e.projects.map((t,n)=>(0,M.jsx)(K,{project:t,index:n,onClickLoad:e.onClickLoad},n))})}var Y=1060,X=h(d)`
  position: relative;
...
`;function ae(e){let t=m(),[n]=w();(0,D.useEffect)(()=>{i(window.location.search).then(({args:e})=>{Object.keys(e).length>0&&(console.log(`Detected URL parameters. Redirecting from landing page to viewer.`),t(`viewer?`+n.toString(),{state:e,replace:!0}))})},[t,n]);let o=(e,n)=>{let r=n?`&hideTitle=true`:``;t(`/viewer?url=${b(e.imageUrl)}${r}`,{state:e})},[s,c]=(0,D.useState)(window.matchMedia(`(prefers-reduced-motion: no-preference)`).matches);return(0,D.useEffect)(()=>{let e=window.matchMedia(`(prefers-reduced-motion: no-preference)`);return e.addEventListener(`change`,()=>{c(e.matches)}),()=>{e.removeEventListener(`change`,()=>{c(e.matches)})}},[]),(0,M.jsxs)(`div`,{style:{backgroundColor:`var(--color-landingpage-bg)`,minHeight:`100%`},children:[(0,M.jsx)(g,{children:(0,M.jsxs)(C,{$gap:12,children:[(0,M.jsx)(C,{$gap:2,children:(0,M.jsx)(a,{onLoad:o})}),(0,M.jsx)(r,{})]})}),(0,M.jsxs)(X,{children:[(0,M.jsxs)(te,{style:{zIndex:1},children:[(0,M.jsx)(`video`,{autoPlay:s,loop:!0,muted:!0,children:(0,M.jsx)(`source`,{src:j,type:`video/mp4`})}),(0,M.jsx)(`div`,{})]}),(0,M.jsxs)(Z,{style:{zIndex:1},children:[(0,M.jsxs)(d,{children:[(0,M.jsx)(`h1`,{children:`Vol-E`}),(0,M.jsx)(`h2`,{children:`An interactive, web-based viewer for 3D volume data`})]}),(0,M.jsx)(`p`,{children:`Vol-E (Volume Explorer) is an open-use online tool designed to visualize, analyze, and interpret multi-channel 3D microscopy data. Ideal for researchers, educators, and students, the viewer offers powerful interactive tools to extract key insights from imaging data.`})]})]}),(0,M.jsx)(Q,{children:(0,M.jsxs)(ne,{children:[(0,M.jsxs)($,{children:[(0,M.jsx)(`h3`,{children:`Multiresolution OME-Zarr support`}),(0,M.jsx)(`p`,{children:`Load your cloud-hosted OME-Zarr v0.4 and v0.5 images via http(s).`})]}),(0,M.jsxs)($,{children:[(0,M.jsx)(`h3`,{children:`Multiple viewing modes`}),(0,M.jsx)(`p`,{children:`Rotate and examine the volume in 3D, or focus on single Z slices in 2D at higher resolution.`})]}),(0,M.jsxs)($,{children:[(0,M.jsx)(`h3`,{children:`Time-series playthrough`}),(0,M.jsx)(`p`,{children:`Interactively explore dynamics and manipulate timelapse videos realtime in 2D or 3D.`})]}),(0,M.jsxs)($,{children:[(0,M.jsx)(`h3`,{children:`Customizable settings`}),(0,M.jsx)(`p`,{children:`Switch colors, toggle channels, and apply thresholds to reveal interesting features in data.`})]})]})}),(0,M.jsx)(re,{children:(0,M.jsx)(`h2`,{style:{margin:0},children:`Load a dataset below or your own data to get started.`})}),(0,M.jsx)(Q,{style:{paddingBottom:`400px`},children:(0,M.jsx)(J,{projects:P,onClickLoad:o})}),(0,M.jsxs)(Q,{style:{padding:`0 30px 40px 30px`,display:`block`},children:[(0,M.jsx)(A,{}),(0,M.jsx)(d,{style:{paddingTop:`20px`},children:(0,M.jsxs)(ie,{type:`text`,className:`ot-sdk-show-settings`,children:[`Cookie settings`,(0,M.jsx)(f,{children:`(opens popup menu)`})]})})]})]})}export{ae as default};